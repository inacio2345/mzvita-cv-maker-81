...
import { FileText, Shield, Lock, Eye, Database, UserCheck, Menu } from 'lucide-react';
      ...
      <section className="py-12 md:py-16 lg:py-20 px-4">
        <div className="container mx-auto max-w-4xl">
          ...
          <Card className="mt-8 md:mt-12 p-6 md:p-8 border-0 shadow-lg">
            <h2 className="text-2xl md:text-3xl font-bold text-gray-900 mb-4 md:mb-6">Informações Detalhadas</h2>
            <div className="space-y-4 md:space-y-6 text-gray-600">
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Cookies e Tecnologias Similares</h3>
                <p className="text-sm md:text-base leading-relaxed">Utilizamos cookies para melhorar sua experiência de navegação, analisar o tráfego do site e personalizar conteúdo. Você pode controlar o uso de cookies através das configurações do seu navegador.</p>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Retenção de Dados</h3>
                <p className="text-sm md:text-base leading-relaxed">Mantemos suas informações pessoais pelo tempo necessário para cumprir os propósitos descritos nesta política, a menos que um período de retenção mais longo seja exigido ou permitido por lei.</p>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Transferências Internacionais</h3>
                <p className="text-sm md:text-base leading-relaxed">Seus dados podem ser transferidos e processados em países fora de Moçambique. Garantimos que essas transferências são realizadas com as devidas proteções de segurança.</p>
              </div>
              <div>
                <h3 className="text-lg md:text-xl font-semibold text-gray-900 mb-2 md:mb-3">Alterações na Política</h3>
                <p className="text-sm md:text-base leading-relaxed">Podemos atualizar esta política periodicamente. Notificaremos sobre mudanças significativas através do email ou aviso em nosso site.</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="mt-6 md:mt-8 p-6 md:p-8 border-0 shadow-lg bg-gradient-to-r from-google-blue to-google-green text-white">
            <div className="text-center">
              <h2 className="text-2xl md:text-3xl font-bold mb-3 md:mb-4">Dúvidas sobre Privacidade?</h2>
