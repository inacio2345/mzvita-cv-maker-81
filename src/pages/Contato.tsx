...
const Contato = () => {
  ...
  const supportInfo = [
    {
      icon: <MapPin className="w-6 h-6 text-google-blue" />,
      title: "Localização",
      description: "Maputo, Moçambique"
    },
    {
      icon: <Clock className="w-6 h-6 text-google-green" />,
      title: "Tempo de Resposta",
      description: "WhatsApp: 1h | Email: 24h"
    },
    {
      icon: <Users className="w-6 h-6 text-google-red" />,
      title: "Equipe Especializada",
      description: "Suporte técnico dedicado"
    },
    {
      icon: <Headphones className="w-6 h-6 text-google-yellow" />,
      ...
      <section className="py-20 px-4">
        <div className="container mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold mb-4 text-gray-900">Como Podemos Ajudar?</h2>
            <p className="text-xl text-gray-600">Escolha a melhor forma de entrar em contato conosco</p>
          </div>
          
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-16">
            {contactMethods.map((method, index) => (
              <Card key={index} className="p-8 text-center hover:shadow-xl transition-all duration-300 border-0 shadow-lg transform hover:scale-105">
                  ...
                  {method.details.map((detail, i) => (
                    <div key={i}>
                      {method.link ? (
                        ...
                        >
                          <Button className="bg-green-600 hover:bg-green-700 text-white w-full text-lg py-3">
                            Abrir WhatsApp
                          </Button>
                        </a>
                      ) : (
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center text-gray-900 mb-12">Horário de Atendimento</h2>
            <div className="grid md:grid-cols-2 gap-8">
              <Card className="p-8 border-0 shadow-lg">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">Atendimento Telefônico</h3>
                </div>
              ...
              <Card className="p-8 border-0 shadow-lg">
                <div className="flex items-center mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-900">WhatsApp & Email</h3>
                </div>
                <ul className="space-y-3 text-gray-600">
                  <li className="flex justify-between">
                    <span>WhatsApp:</span>
