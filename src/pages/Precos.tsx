        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="hidden md:flex space-x-8">
              ...
              <a href="/precos" className="text-google-blue font-semibold">Preços</a>
        ...
        <div className="container mx-auto">
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {plans.map((plan, index) => (
              <Card key={index} className={`relative p-8 border-0 shadow-lg hover:shadow-xl transition-all ${
                ...
                <div className="text-center mb-8">
                  ...
                  <div className="mb-4">
                    ...
                    <span className="text-xl text-gray-600 ml-1">MT</span>
                  </div>
          ...
          <div className="mt-16 text-center">
            <h3 className="text-2xl font-bold text-gray-900 mb-6">Métodos de Pagamento</h3>
            <div className="bg-white rounded-2xl p-8 shadow-lg max-w-2xl mx-auto">
              <div className="flex justify-center items-center space-x-8">
                ...
                <div className="text-center">
                  ...
                  <p className="text-gray-700 font-medium">E-Mola</p>
                </div>
                <div className="text-center">
                  <div className="w-16 h-16 bg-green-100 rounded-full flex items-center justify-center mx-auto mb-2">
                    <span className="text-green-600 font-bold text-xl">MB</span>
                  </div>
                  <p className="text-gray-700 font-medium">Mkesh</p>
                </div>
              </div>
