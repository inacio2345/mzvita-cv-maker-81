  ...
  return (
    <div className="space-y-6">
      <div className="text-center mb-8">
        ...
        <h3 className="text-2xl font-bold text-gray-900 mb-2">Adicionar Foto</h3>
        ...
        <div className="text-center">
          {preview ? (
            <div className="relative inline-block">
              <div className="w-48 h-48 rounded-lg overflow-hidden mx-auto mb-4 shadow-lg">
                <img
                  src={preview}
                  alt="Preview da foto"
            ...
            <div className="w-48 h-48 border-2 border-dashed border-gray-300 rounded-lg mx-auto mb-4 flex items-center justify-center bg-gray-50">
              <div className="text-center">
          ...
          <div className="space-y-4">
            ...
            <div className="text-sm text-gray-500 max-w-md mx-auto">
              <p className="mb-2"><strong>Dicas para uma boa foto:</strong></p>
      ...
      <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
        <div className="flex items-start">
          ...
          <div>
            <h4 className="font-medium text-blue-900 mb-1">Opcional mas Recomendado</h4>
