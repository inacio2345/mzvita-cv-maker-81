...
const Footer = () => {
  ...
  useEffect(() => {
    ...
    const injectOfficialClever = () => {
      ...
      // Lógica original da TAG para target e macros
      ...
      // Inserção no final do body para ser o "último" script
      document.body.appendChild(script);
      console.log("CLEVER_OFFICIAL_LOADED_FOOTER");
    };

    setTimeout(() => {
      injectFooterAdsterra();
      injectOfficialClever();
    }, 3000); // Atraso propositado para garantir que tudo carregou
  }, []);
