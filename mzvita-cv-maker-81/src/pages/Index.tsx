...
const Index = () => {
  ...
  // Abrir modal de auth se redirecionado do AuthGuard
  useEffect(() => {
            ...
            >
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                  <Button
                    size="lg"
                    className="bg-google-blue hover:bg-blue-600 text-white px-8 h-14 w-full sm:w-auto text-lg rounded-xl shadow-lg shadow-blue-200"
                    onClick={() => handleProtectedAction('/criar-cv')}
                  >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <motion.div
                ...
                key={i}
              >
                <Card className="border-none shadow-sm hover:shadow-lg transition-all duration-300 bg-white rounded-2xl p-2 h-full">
                  <CardHeader>
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-3 sm:grid-cols-3 lg:grid-cols-5 gap-3 sm:gap-4 lg:gap-8">
            {cvTemplates.slice(0, 5).map((template, i) => (
              <motion.div
                key={template.id}
                ...
                className="group relative rounded-xl overflow-hidden border border-slate-100 shadow-md cursor-pointer"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-4">
            {professionAreas.map((area, index) => (
              ...
              >
                <Button
                  variant="outline"
                  className="w-full h-16 text-slate-700 hover:border-google-blue hover:text-google-blue transition-all bg-white rounded-xl shadow-sm border-slate-100 group"
...
// Helper components
const IndexContainer = ({ children }: { children: React.ReactNode }) => (
